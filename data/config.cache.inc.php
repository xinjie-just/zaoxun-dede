...
$cfg_basehost = 'http://zaoxun-dede.com';
$cfg_cmspath = '';
$cfg_cookie_encode = '90OdFAPgKl0Dlu2ogvlgiwIIRiWbkYCC';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '首页';
$cfg_webname = '成都早寻智能科技股份有限公司';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright © 2017 PP-Panda';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '个人健康管理,健康小区建设,基础医疗服务,HCC,智能、便捷、全面,远程医疗服务';
$cfg_description = 'HCC日常健康管理体系是以个人为中心的健康生活平台，引导全民积极参与健康管理，为个人提供全面的健康生活服务，帮助人们建立科学合理的生活方式和健康管理方式的服务平台。';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
